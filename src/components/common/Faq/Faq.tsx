...
const Faq = () => (
  <div className={style.faqComponent}>
    <section className={style.section}>
      ...
      <h3>Backend</h3>
      <p>
        The backend of the application is created with Node.js using Express to
        build the API. Data is stored in a MongoDB database, enabling
      ...
      <p>
        ...
        MongoDB. Stylowanie zostało wykonane za pomocą CSS3 i Styled Components.
      </p>
